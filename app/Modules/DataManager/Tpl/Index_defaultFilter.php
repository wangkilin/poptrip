...
foreach($FilterSteps as $_stepKey=>$_stepInfo) {
    ...
    if(is_array($_stepInfo)) {
        foreach($_stepInfo as $__stepKey=>$__stepInfo) {
            ...
            $stepHiddenParam[$stepIndex] .= '<input type="hidden" name="'.$__stepInfo.'" value="'.I($__stepInfo, '').'"/>';
        ...
        $stepHiddenParam[$stepIndex] .= '<input type="hidden" name="'.$_stepInfo.'" value="'.I($_stepInfo, '').'"/>';
