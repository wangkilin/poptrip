...
class OTA_Cancel
{
	public $open_api = '/Hotel/OTA_Cancel.asmx';
	
	public $order_id; // 订单号
	public $unique_id; // 联盟用户在携程的uniqueid
	public $reason = array(); // 退单原因类型代码，参考CodeList(CXR)
	public $time_stmp;
	...
	public function __construct( $open_api, $args )
	{
		...
		if( array_key_exists('reason', $args) && $args['reason'] )
		{
		...
		$request_xml = 
			...
			.'<HotelRequest>'
				...
				.'xmlns:xsd="http://www.w3.org/2001/XMLSchema">'
					.'<ns:OTA_CancelRQ TimeStamp="'.$this->time_stmp.'" Version="1.0">'
						...
						.'<ns:Reasons><ns:Reason Type="'.$this->reason.'"/></ns:Reasons>'
					.'</ns:OTA_CancelRQ>'
				.'</RequestBody>'
			.'</HotelRequest>'
			.'</Request>';
