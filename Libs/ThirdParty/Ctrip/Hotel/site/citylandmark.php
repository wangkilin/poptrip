...
$city=$SiteDefaultCityName;//选择的城市名称
...
$kw=autoLoadKeywords('citylandmark.php',$searchArr,$replaceArr);
...
?>
	<!-- bd begin -->
	<div class="bd bd_landmark">
		<div class="path_bar">
<?php 
//构造搜索页的副导航
echo getSubTitleNavigation("citylandmark","");
?>
		</div>
<?php
...
include_once 'module/main_hotelSearch_term.php';//加载搜索页面的条件选择器 ?>
		<div class="landmark box_blue">
			<h2><?php echo $cityName?>热门城市地标分类</h2>
			
		<?php 
		$pageType='2';
		$getNums='0';
		include_once '../SDK.config.php';
		include_once 'ajaxrequest/hotCityLandMarkRequest.php';
		?>
