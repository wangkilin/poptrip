...
/**
 *
 * 获取酒店的详细信息（酒店图片）（此接口为D_HotelDetail拆分接口，请求体与D_HotelDetail一致）
 * @author cltang
 *
 */
class get_D_HotelPicList{
	/**
	 * 城市的ID，必须填写
	 */
	var $CityID="";
...
BEGIN;
	...
	function main(){
		try{
	 	...
	 	$commonRequestDo->requestURL=D_HotelPicList_Url;
