...
/**
 *
 * 获取酒店的详细信息（周边交通）（此接口为D_HotelDetail拆分接口，请求体与D_HotelDetail一致）
 * @author cltang
 *
 */
class get_D_HotelPlaceInfoList{
	/**
	 * 城市的ID，必须填写
	 */
	var $CityID="";
	...
	private  function getRequestXML()
	{
		...
		$SID=Sid;
		$KEYS=SiteKey;
		$RequestType="D_HotelPlaceInfoList";
		//构造权限头部
...
BEGIN;
	...
	function main(){
		try{
	 	...
	 	$commonRequestDo->requestURL=D_HotelPlaceInfoList_Url;
