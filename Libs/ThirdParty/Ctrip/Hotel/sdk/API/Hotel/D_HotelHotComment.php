<?php
/**
 * 请求D_HotelHotComment的服务(最新热门酒店点评)
 */
class get_D_HotelHotComment{
...
<Request>
<Header $headerRight/>
<DomesticHotelHotCommentResquest>$HotelIDss</DomesticHotelHotCommentResquest>
</Request>
BEGIN;
	return  $paravalues;
	}
	...
	function main(){
		try{
	 	...
	 	$commonRequestDo->requestURL=D_HotelHotComment_Url;
