<?php
/**
 * 请求D_HotelSubRoomList的服务(请求体与D_HotelSearch  一样，根据不同的接口返回不同的数据)
 */
class get_D_HotelSubRoomList{
	/**
	 * @var城市的ID，必须填写
	 */
	var $CityID="";
	...
	private  function getRequestXML()
	{
		...
		$SID=Sid;
		$KEYS=SiteKey;
		$RequestType="D_HotelSubRoomList";
		//构造权限头部
...
//echo $paravalues;
			...
			function main(){
				try{
					...
					$commonRequestDo->requestURL=D_HotelSubRoomList_Url;
